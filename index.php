...
<body>
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-links">
                <li><a href="actions/about.php">About</a></li>
                <li><a href="actions/services.php">Services</a></li>
                <li><a href="actions/explore.php">Explore</a></li>
    ...
    <main>
        <section class="estates-section">
            ...
            <div class="estates-grid">
                ...
                <div class="estate-card">
                    <img src="assets/static/wdf.jpg" alt="Waterfront Property with Dock, La Puerta">
                    <div class="estate-info">
                ...
                <div class="estate-card">
                    <img src="assets/static/denton.jpg" alt="Image of property">
                    <div class="estate-info">
